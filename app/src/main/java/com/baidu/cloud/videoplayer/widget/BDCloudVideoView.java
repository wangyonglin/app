...
public class BDCloudVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    public interface OnPortraitStateListener{
        public void OnPortraitStateChanged(final PlayerState nowState);
    }
    public void setOnPortraitStateListener(OnPortraitStateListener listener) {
        mOnPortraitStateListener = listener;
    }
    ...
    private OnPortraitStateListener mOnPortraitStateListener;
