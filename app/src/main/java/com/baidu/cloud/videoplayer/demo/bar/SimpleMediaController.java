...
public class SimpleMediaController extends RelativeLayout {
    ...
    private void initUI(Context context) {
        ...
        fullButton = (ImageButton) layout.findViewById(R.id.btn_fullscreen);
        fullButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                SimplePlayActivity simplePlayActivity = (SimplePlayActivity)context;
                ScreenUtil.changeStatus(simplePlayActivity);
            }
        });
